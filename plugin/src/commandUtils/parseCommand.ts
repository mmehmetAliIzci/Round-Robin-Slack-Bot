export type OperationType = 'create' | 'remove' | 'add-assignee' | 'remove-assignee' | 'next' |'delete' |'';
...
const allowedOperations: Array<string> = ['create', 'remove', 'add-assignee', 'remove-assignee', 'next', 'delete'];
